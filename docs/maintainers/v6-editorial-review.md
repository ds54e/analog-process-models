...
| Model origin and use limits | [Provenance and license account](../../THIRD_PARTY.md), [APM045 positioning](../../APM045_POSITIONING.md), and each local provenance manifest; upstream-derived APM350/APM130/APM045 are distinguished from independently authored generic APM022/APM016F. No manufacturable-PDK, silicon calibration or foundry/yield claim is made. |
